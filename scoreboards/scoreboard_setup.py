...
def write_values(delete=False):
    ...
    if allset() or delete:
        ...
        files = ['scoreboards/' + dir + r'/positions.txt', dir + r'/sizes.txt']
...
sport_list = [i for i in glob.glob("*jpg")]
